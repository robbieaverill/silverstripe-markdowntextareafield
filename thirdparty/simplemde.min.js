...
function drawLink(editor) {
    ...
    if (options.promptURLs) {
        ...
        //Call to the modal class in here
        var newModal = jQuery('body').modal().init();
        newModal.open({
            ...
            " <br /><br /><strong>Note</strong>: Asset link URLs should start with a slash (/)",
            load: function () {
                jQuery("#link-autocomplete").autocomplete({
                    source: function (request, response) {
                        jQuery.ajax({
                            ...
                            url: "/admin/markdown/internallinks",
                            dataType: "json",
                            data: {term: request.term},
                            success: function (data) {
                                var results = jQuery.map(data, function (dataItem) {
                                    return {
                    ...
                    select: function (event, ui) {
                        ...
                        if (jQuery("#link-copy").val() == "") {
                           jQuery("#link-copy").val(suggestion.label);
                        }
                    }
...
function linkCallback(editor, url, modalInstance) {
    var cm = editor.codemirror;
